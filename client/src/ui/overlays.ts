...
export function fillHowTo(scene: Phaser.Scene, panel: Panel): void {
  const lines = [
    ...
    '· TRIPULACIÓN: especialistas que reparan, apagan fuegos y potencian',
    '  sistemas. Selecciónalos con clic izq. (arrastra para elegir varios)',
    '  y mándalos a una sala con CLIC DERECHO.',
